...
class getDoctrine_Dbal_DefaultConnectionService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->setMiddlewares([]);
        $a->setSQLLogger(new \Doctrine\DBAL\Logging\LoggerChain([0 => new \HalloVerden\DoctrineSqlLoggerBundle\Loggers\QueryExecutionTimeLogger(($container->privates['monolog.logger'] ?? $container->getMonolog_LoggerService()))]));
