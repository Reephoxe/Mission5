...
class ItemsConfig 
{
     ...
     * @return $this
     */
    public function isDivider($value): self
    {
     ...
     * @return $this
     */
    public function routeParameters($value): self
    {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('items', $value)) {
            $this->_usedProperties['items'] = true;
            $this->items = array_map(function ($v) { return new \Symfony\Config\BootstrapMenu\MenuConfig\ItemsConfig\ItemsConfig($v); }, $value['items']);
            unset($value['items']);
        }
